        ...
        <section class="Operators">
            <div class="OperatorsText">
                <div>
                    ...
                    <p className="P1">Um operador de comparação compara seus operandos e retorna um valor lógico baseado em se a comparação é verdadeira. Os operandos podem ser numéricos, strings, lógicos ou objetos. Na maioria dos casos, se dois operandos não são do mesmo tipo, o JavaScript tenta convertê-los para um tipo apropriado. Isto geralmente resulta na realização de uma comparação numérica. A seguir conheça os Operadores de Comparação: </p>
                </div>
            </div>
         </section>
    )
